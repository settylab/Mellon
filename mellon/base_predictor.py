...
class Predictor(ABC):
    ...
    implement the `_predict` method for making predictions.
...
class ExpPredictor(Predictor):
    """
    Abstract base class for predictor models which returs the exponent of its `_predict` method upon a call.
