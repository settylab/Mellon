...
def compute_mu(nn_distances, d):
    ...
    :type d: Dimensions.
    :type d: int
    :return mu: The 1th percentile of mle(nn_distances, d) - 10.
    :rtype: float
    """
...
def compute_initial_value(nn_distances, d, mu, L):
    ...
    such that the initial value z minimizes :math:`||Lr + mu - mle(r, d)|| + ||z||`,
    where r = nn_distances.

    :param nn_distances: Nearest neighbor distances.
    :type nn_distances: array-like
    :param d: Dimensions.
    :type d: int
    :param mu: Gaussian Process mean.
    :type mu: int
    :param L: L such that :math:`L L^T \approx K`, the covariance matrix.
    :type L: array-like
    :return initial_value: z
    :rtype: array-like
    """
